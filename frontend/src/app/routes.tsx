      ...
      >
        <Routes>
          ...
          <Route element={<MainLayout />}>
            ...
            <Route path="otp/reset-password" element={<OtpResetPasswordPage />} />
            <Route
          ...
          <Route path="provider" element={<ProviderLayout />}>
            ...
            <Route
              ...
              element={
                <ErrorBoundary fallback={<div className="h-80">Chat loading failed</div>}>
                  <ChatPage />
                </ErrorBoundary>
              }
            />
          ...
          <Route path="client" element={<ClientLayout />}>
            ...
            <Route path="categories" element={<HomeCategory isClientLogin={true} />} />
            <Route
              path="giglistings/:slug"
              element={
                <ErrorBoundary fallback={<div className="h-80">Provider Listing failed</div>}>
