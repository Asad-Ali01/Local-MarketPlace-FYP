...
import { Star, MapPin, BadgeCheck, Clock3, ArrowRight } from 'lucide-react';
...
function GigListings() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-5 py-10">
      <h1 className="text-3xl font-bold mb-8">Web Development Providers</h1>
            ...
            <div className="flex flex-col gap-6 md:flex-row">
              ...
              <div className="flex-1">
                <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      <h2 className="text-xl font-bold">{gig.provider.name}</h2>

                      <BadgeCheck size={20} className="text-blue-600" />
                    </div>

                    <p className="mt-1 text-gray-700 font-medium">{gig.title}</p>
                  ...
                  <div className="text-left md:text-right">
                    ...
                    {gig.startingPrice && <p className="text-sm text-gray-500">Starting Price</p>}
                  </div>
                </div>
                ...
                <div className="mt-6 flex justify-end">
                  <button
                    className="flex items-center gap-2 rounded-lg cursor-pointer bg-blue-700 px-5 py-3 font-medium text-white transition hover:bg-blue-800"
