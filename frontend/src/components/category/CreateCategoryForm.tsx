    ...
    <Card>
      ...
      <CardContent>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
          <CustomField label="Category Name" error={form.formState.errors.name?.message}>
            <Input placeholder="Information Technology" {...form.register('name')} />
          </CustomField>

          <CustomField label="Category Icon" error={form.formState.errors.icon?.message}>
            <Controller
              name="icon"
