...
export default function ViewGigDetailsById() {
  ...
  const { data, isLoading, isError } = useGigDetailsByGigIdQuery(gigId!, {
    skip: !gigId,
  });

  if (isLoading) {
    return <div className="mx-auto max-w-7xl p-10">Loading...</div>;
  }

  if (isError || !data?.data) {
    return <div className="mx-auto max-w-7xl p-10">Gig not found.</div>;
  }
