...
function CreateGigStepper() {
  ...
  const form = useForm<ProviderGigSchemaInputType, any, ProviderGigSchemaType>({
    ...
    <div className="min-h-screen p-3 flex items-center justify-center ">
      <FormProvider {...form}>
        <form
          ...
          className={`space-y-6 my-7  flex flex-col border-2 shadow-2xl p-2 sm:p-10 items-center max-w-3xl w-full rounded-3xl  justify-center py-4  `}
        >
          ...
          <div className=" w-full sm:max-w-3xl space-y-2">
            ...
            <div className="flex gap-3 mt-4 justify-end">
              {step == 3 && <Button htmlType="submit">Skip </Button>}
              {step > 1 && (
                <Button className="justify-self-end" onClick={previousStep} type="default">
                  <ArrowLeft />
                  Previous
                </Button>
              )}
