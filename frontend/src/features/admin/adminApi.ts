...
export const adminApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    adminAllUsersApi: builder.query<
      IAdminAllUsersResponse,
      { page: number; filterStatus: string; searchUser: string }
    >({
    ...
    adminCreateSubCategory: builder.mutation<
      ISubCategoryResponse,
...
export const {
  ...
  useAdminCreateSubCategoryMutation,
