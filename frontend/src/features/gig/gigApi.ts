...
import type { ICreateGigResponse, IGetAllMyGigsResponse, IGetGigDetailsById,  IGetLocationSuggestionsResponse, IGetMyGigDetailsResponse, IGig, IProviderDashboardTopCardResponse, IProviderGetAllGigsByCategoryResponse } from "../../types/gig.types";
...
export const {useGetMyGigsApiQuery,useCreateGigApiMutation,useProviderDashboardTopCardQuery,useGetAllGigsByCategoryQuery,useGetAllMyGigsQuery,useDeleteGigMutation,useGigDetailsByGigIdQuery,useLazyGetLocationSuggestionsQuery} = gigApi;