...
import { adminAllUsers, adminDeleteUser, adminEditUser, adminLogin,  adminStats, adminUserDetails, createCategory, createSubCategory, getAllCategories, getAllSubCategories } from "../controllers/admin.controller";
...
router.route('/category').get(verifyJWT,authorrizeRoles("admin","provider"),getAllCategories);
router.route('/sub-category').get(verifyJWT,authorrizeRoles("admin","provider"),getAllSubCategories);
